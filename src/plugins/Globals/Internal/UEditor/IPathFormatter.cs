...
namespace Globals.Internal.UEditor
{
    /// <summary>
    /// 定义一个路径格式化程序。
    /// </summary>
    ...
    /// 表示一个基于授权的路径格式化程序。
    /// </summary>
    public class AuthPathFormatter : PathFormatter
    {
        private readonly IAppStorage _appStorage;

        /// <summary>
        /// 初始化一个 <see cref="AuthPathFormatter"/> 类的新实例。
        /// </summary>
        /// <param name="appStorage">应用程序存储池。</param>
        public AuthPathFormatter(IAppStorage appStorage)
        {
