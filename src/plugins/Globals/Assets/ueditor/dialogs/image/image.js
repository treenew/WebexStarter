...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            var isHiddenUploadButtons = false;
            var autoClose = false;
            function toggleFileLimitState() {
                if (fileNumLimit < 1) return;
                if (fileNumLimit == fileCount) {
                    $("#filePickerBtn").hide();
                    $filePickerBlock.hide();
                    isHiddenUploadButtons = true;
                    if (fileNumLimit == 1) {
                        setTimeout(function() {
                            autoClose = true;
                ...
                else if (isHiddenUploadButtons) {
                    $("#filePickerBtn").show();
                    $filePickerBlock.show();
                    isHiddenUploadButtons = false;
                }
            }
